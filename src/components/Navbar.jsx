            ...
            <header className={`navbar ${scrolled ? 'navbar-scrolled' : ''}`}>
                <div className="navbar-inner container-lg">
                    ...
                    <NavLink to="/" className="navbar-logo">
                        <img src="/images/roaminglogo_transparent.png" alt="Roaming Directions Logo" className="navbar-logo-img" height="42" width="100" />
                    </NavLink>
            ...
            <div className={`mobile-overlay ${menuOpen ? 'open' : ''}`}>
                <nav className="mobile-nav">
                    <div className="mobile-logo">
                        <img src="/images/roaminglogo_transparent.png" alt="Roaming Directions Logo" className="mobile-logo-img" height="48" width="114" />
                    </div>
